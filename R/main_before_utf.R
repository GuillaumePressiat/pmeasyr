  ...
  if (annee==2011){
    ...
    rum_i <- readr::read_fwf(paste0(path,"/",finess,".",annee,".",mois,".rss.txt"),
      ...
      dplyr::mutate(
        ...
        NAS           = stringr::str_sub(RUM,36,55) %>% stringr::str_trim(),
        NORUM         = stringr::str_sub(RUM,56,65) %>% stringr::str_trim(),
        ...
        RDT_TYPMACH   = ifelse(NOVERG=='115', stringr::str_sub(RUM,141,141) , stringr::str_sub(RUM,149,149)),
        RDT_TYPDOSIM  = ifelse(NOVERG=='115', stringr::str_sub(RUM,142,142) , stringr::str_sub(RUM,150,150)),
        NOINNOV       = ifelse(NOVERG=='115', "", stringr::str_sub(RUM,151,165)),   
        NBFAISC       = ifelse(NOVERG=='115', stringr::str_sub(RUM,143,143), "") %>% as.integer(),
